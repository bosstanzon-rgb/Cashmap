    ...
    >
      <ModalBackdrop intensity={56}>
        <Pressable className="flex-1 items-center justify-center px-4 py-8" onPress={onMaybeLater}>
          <Pressable
            className="max-h-[92%] w-full max-w-md overflow-hidden rounded-3xl bg-cm-surface shadow-cm-card"
          ...
          >
            ...
            >
              <View className="bg-cm-raised px-6 pb-7 pt-8">
                ...
                <View className="mt-5 rounded-2xl bg-cm-accent-soft px-4 py-4">
                ...
                <View className="mt-6 gap-3.5 rounded-2xl bg-cm-canvas px-4 py-4">
                  {BENEFITS.map((line) => (
